'use strict';
app.factory('authService', ['$http', '$q', '$location', 'localStorageService', 'ngAuthSettings',
        ...
        var _obtainAccessToken = function (externalData) {
            ...
            $http.get(serviceBase + 'api/account/ObtainLocalAccessToken', {
                ...
                localStorageService.set('authorizationData', {
                    ...
                    refreshToken: "",
                    useRefreshTokens: false,
                    useExternalTokenProvider: true,
                    externalTokenProvider: externalData.externalAccessToken,
